...
- [x] FR-001: 版本读取 - 读取所有版本文件的当前版本
- [x] FR-002: 版本验证 - 检查版本格式是否符合 semver
- [x] FR-003: 版本比较 - 检测版本文件间的不一致
- [x] FR-004: 版本更新 - 更新所有版本文件到指定版本
- [x] FR-005: 变更检测 - 检测自上次发布以来的变更

### 非功能需求

- [x] NFR-001: 同步操作 < 1 秒
- [x] NFR-002: 支持 dry-run 模式
- [x] NFR-003: 原子性更新（全部成功或回滚）
