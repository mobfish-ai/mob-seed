...
- [x] FR-001: 前置检查 - 验证工作区干净、测试通过
- [x] FR-002: 版本更新 - 调用 bump-version 更新所有文件
- [x] FR-003: CHANGELOG 生成 - 生成版本变更条目
- [x] FR-004: Git 操作 - 创建 commit 和 tag
- [x] FR-005: 推送触发 - 推送到远程触发 CI
- [x] FR-006: CI 发布 - 自动创建 GitHub Release

### 非功能需求

- [x] NFR-001: 发布脚本 < 30 秒完成
- [x] NFR-002: 支持 dry-run 模式
- [x] NFR-003: 失败时提供回滚指导
