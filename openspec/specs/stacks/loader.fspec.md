...
**Acceptance Criteria:**
- [ ] AC-001: 返回 StackDiscoveryResult，包含 stacks Map 和 skipped 数组
- [ ] AC-002: 跳过无 stack.json 或配置无效的目录
...
**Acceptance Criteria:**
- [ ] AC-009: 根据 prompts 配置查找文件
- [ ] AC-010: 文件不存在时返回 null
...
**Acceptance Criteria:**
- [ ] AC-011: 根据 template 配置查找文件
- [ ] AC-012: 文件不存在时返回 null
