...
**文件**:
- `mob-seed.md` - 主入口命令
- `mob-seed-init.md` - 项目初始化
- `mob-seed-spec.md` - 规格定义
- `mob-seed-emit.md` - 自动派生
- `mob-seed-exec.md` - 自动执行
- `mob-seed-defend.md` - 守护规范
- `mob-seed-status.md` - 状态查看
- `mob-seed-diff.md` - 差异对比
- `mob-seed-sync.md` - 强制同步
- `mob-seed-archive.md` - 归档提案
- `mob-seed-edit.md` - 编辑触发
...
1. 审查生成的规格文件，补充业务细节
2. 运行 `/mob-seed-status` 验证同步状态
3. 使用 `/mob-seed-diff` 检查规格与代码的详细差异
