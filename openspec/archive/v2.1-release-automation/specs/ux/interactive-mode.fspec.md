...
- [x] FR-001: 交互式确认 - 危险操作前请求用户确认
- [x] FR-002: 选项菜单 - 多选项时显示编号菜单
- [x] FR-003: 上下文感知 - 根据项目状态智能推荐
- [x] FR-004: 错误恢复 - 中断后可继续上次操作
- [x] FR-005: 进度显示 - 长任务显示进度条
- [x] FR-006: 批量确认 - 支持全选或单选操作

### 非功能需求

- [x] NFR-001: 响应延迟 < 100ms
- [x] NFR-002: 支持非 TTY 环境回退
- [x] NFR-003: 终端宽度自适应
