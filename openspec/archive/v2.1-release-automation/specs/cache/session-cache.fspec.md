...
- [x] FR-001: 分层缓存 - 支持 quick/incremental/full 三层缓存
- [x] FR-002: 结果存储 - 缓存检查结果和元数据
- [x] FR-003: 有效性检查 - 基于文件 hash 检查缓存有效性
- [x] FR-004: 层级复用 - 高层复用低层已通过的结果
- [x] FR-005: 自动失效 - 文件变更时自动失效相关缓存
- [x] FR-006: TTL 管理 - 不同层级不同过期时间
